...
import { Shield, AlertTriangle, BarChart2, Lock, Percent, Clock } from 'lucide-react'

export function RiskManagement() {
  const rules = [
    {
      title: "Maximum Daily Drawdown",
      description: "Daily losses cannot exceed 5% of your account balance",
      icon: Shield,
      color: "red"
    },
    {
      title: "Maximum Total Drawdown",
      description: "Total losses cannot exceed 10% of your initial balance",
      icon: AlertTriangle,
      color: "orange"
    },
    {
      title: "Position Sizing",
      description: "Maximum position size of 2% per trade",
      icon: BarChart2,
      color: "blue"
    },
    {
    ...
    },
    {
      ...
      description: "Minimum risk-reward ratio of 1:2 per trade",
      icon: Percent,
      color: "purple"
    },
    {
      title: "Trading Hours",
      description: "Trading allowed during major market sessions only",
      icon: Clock,
      color: "yellow"
    }
  ]
