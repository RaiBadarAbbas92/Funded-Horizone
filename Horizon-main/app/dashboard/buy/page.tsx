...
const PAYMENT_METHODS = [
  {
    ...
    address: "TRx2K8qXcPq89aXvPithgNbwQpBDxBUvxt"
  },
  {
    value: "bnb-bep20",
    label: "BNB (BEP20)",
    image: "/coins/bnb-bep20.png", 
    address: "0x742d35Cc6634C0532925a3b844Bc454e4438f44e"
  },
  {
    value: "eth-erc20",
    label: "ETH (ERC20)",
    image: "/coins/eth-erc20.png",
    address: "0x742d35Cc6634C0532925a3b844Bc454e4438f44e"
  },
  {
    value: "sol",
    label: "Solana (SOL)", 
    image: "/coins/sol.png",
    address: "2WgxRPZvk3GgLtANhiNrKZHkFgvYkerXqPvxZxsYwTBf"
  },
  {
    value: "btc",
    label: "Bitcoin (BTC)",
...
export default function BuyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('https://bb6d-39-37-225-30.ngrok-free.app/order/order', {
        method: 'POST',
        headers: {
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 gap-6">
                        <div className="space-y-2">
                          <Label htmlFor="username" className="text-lg">Full Name</Label>
                          <Input 
                            id="username"
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-4">
                          <Label className="text-lg">Challenge Type</Label>
                        ...
                        <div className="space-y-4">
                          <Label className="text-lg">Account Size</Label>
                        ...
                        <div className="space-y-4">
                          <Label className="text-lg">Trading Platform</Label>
                  ...
                  {currentStep === 3 && (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                          <Label htmlFor="txid" className="text-lg">Transaction ID</Label>
                          <Input 
                            id="txid"
