...
const sidebarItems = [
  ...
  { 
    ...
    description: "Live trading and analysis"
  },
  { 
    icon: Users, 
    label: "Referral", 
...
export function Sidebar() {
    ...
    return (
      <>
        ...
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          <SheetContent side="left" className="w-80 p-0 bg-[#0d2339] border-r border-gray-800/50">
            <SidebarContent />
          </SheetContent>
        </Sheet>

        {/* Desktop Sidebar */}
        <div className="hidden md:block fixed inset-y-0 left-0 w-80 bg-[#0d2339] border-r border-gray-800/50">
          <SidebarContent />
        </div>
      </>
    )
  ...
  return (
    <div className="hidden md:block fixed left-0 top-0 h-screen w-80 bg-gradient-to-br from-[#0A1428] to-[#1E3A5F] text-white border-r border-orange-500/20 shadow-2xl">
      <SidebarContent />
    </div>
  )
}
