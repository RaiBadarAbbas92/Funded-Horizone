...
export function AdminTables({ selectedSection }: AdminTablesProps) {
  ...
  useEffect(() => {
    fetch("https://again-dseradaedqfbd0ca.canadacentral-01.azurewebsites.net/auth/users")
  ...
  useEffect(() => {
    ...
    fetch("https://again-dseradaedqfbd0ca.canadacentral-01.azurewebsites.net/order/completed_orders")
      .then((response) => response.json())
      .then((data) => {
    ...
    fetch("https://again-dseradaedqfbd0ca.canadacentral-01.azurewebsites.net/order/orders")
      .then((response) => response.json())
      .then((data) => {
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://again-dseradaedqfbd0ca.canadacentral-01.azurewebsites.net/order/complete_order/${orderId}`, {
        method: 'POST',
        body: formData
      })
  ...
  const handleConfirmOrder = async (order: OrderDetails) => {
    try {
      ...
      const response = await fetch(`https://again-dseradaedqfbd0ca.canadacentral-01.azurewebsites.net/order/update/${order.id}`, {
        method: 'POST',
        body: formData
      })
